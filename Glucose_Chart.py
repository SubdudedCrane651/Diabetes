...
df = pd.read_excel(file_path, sheet_name="Glycèmie_De_Richard_Perreault", skiprows=3)
...
glucose_readings_raw = df.loc[0:999, "Glycémie"]  # F5:F1000
...
for wb in excel.Workbooks:
    if wb.FullName.lower().find(file_path.lower().split("/")[-1])!=-1:
        ...
        ws = wb.Sheets("Glycèmie_De_Richard_Perreault")  # Select the correct sheet
