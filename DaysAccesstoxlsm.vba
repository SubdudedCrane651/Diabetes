...
Public Sub CreateDiabetesQrys(days)
    ...
    newSQL = "SELECT Diabetes.Datevar, Diabetes.Timevar, Diabetes.Reading FROM Diabetes WHERE (((Diabetes.Datevar) >= Date() - " + Str(days) + ") And ((Diabetes.Timevar) <= #11:59:00 AM#) And ((Year([Diabetes].[Datevar])) = 2025)) ORDER BY Diabetes.Datevar DESC;"
    ...
    newSQL = "SELECT Diabetes.Datevar, Diabetes.Timevar, Diabetes.Reading FROM Diabetes WHERE (((Diabetes.Datevar) >= Date() - " + Str(days) + ") And ((Diabetes.Timevar) >=#11:59:00 AM# And (Diabetes.Timevar)<=#5:00:00 PM#) And ((Year([Diabetes].[Datevar])) = 2025)) ORDER BY Diabetes.Datevar DESC;"
    ...
    newSQL = "SELECT Diabetes.Datevar, Diabetes.Timevar, Diabetes.Reading FROM Diabetes WHERE (((Diabetes.Datevar) >= Date() - " + Str(days) + ") And ((Diabetes.Timevar) > #5:00:00 PM#) And ((Year([Diabetes].[Datevar])) = 2025)) ORDER BY Diabetes.Datevar DESC;"
